var pins_config = {
  "pins":[
  {
    ...
    "hover": "<b><u>DUBLIN</u></b><br>Write any text and load images<br><img src='example.png'>",//info of the popup
    "pos_X": 489,//check the X, Y coordinates guide in the documentation
    "pos_Y": 401,
  ...
  {
    "shape": "circle",
    "hover": "<b><u>CORK</u></b><br><span style='color: #bcbcbc;'>Street Address:</span><br>&nbsp;321 Example, Address 54321<br><span style='color: #bcbcbc;'>Telephone:</span><br>&nbsp;(256) 555-4321 / (256) 555-1234",
    "pos_X": 258,
    "pos_Y": 678,
    "size": 20,
    "outline": "#660000",
...
function iejsAddEvent(id) {
  ...
  if(pins_config.pins[id].active === true){
    ...
    obj.hover(function () {
      jQuery("#iejstip").show().html(pins_config.pins[id].hover);
